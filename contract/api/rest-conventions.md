...
- 语言：服务端声明解析 `Accept-Language` 入上下文（**2026-09-16 EP3-R 拍板：i18n 就绪位**——v1 错误 message 默认文案不随语言变，`error-codes` 的 key 是将来本地化渲染锚点，见 [error-codes.md](error-codes.md) 实现规则 4）
- 金额：字符串或整型分值，不用浮点
- ID：不透明 string
