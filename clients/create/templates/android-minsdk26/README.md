# {{packageName}}（yarch Android 模板 · minsdk26 默认档）

yarch Android 工程模板（[contract/clients/android.md](../../../../contract/clients/android.md) 全条文载体；本档 minSdk 26，扩展档见 `../android-minsdk24/`）。
...
- `settings.gradle.kts` 的 `includeBuild("../../../android")` 为发版前本地源码消费（对偶 golang replace 行）；yarch-client-android 上 Central 后删该行，依赖改正式版本。
