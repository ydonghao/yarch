package io.github.ydonghao.yarch.examples.ddd.application.service;
...
import io.github.ydonghao.yarch.examples.ddd.domain.repository.ProductRepository;
...
public class ProductApplicationService {
    ...
    public io.github.ydonghao.yarch.common.web.PageData<Product> page(int page, int pageSize) {
