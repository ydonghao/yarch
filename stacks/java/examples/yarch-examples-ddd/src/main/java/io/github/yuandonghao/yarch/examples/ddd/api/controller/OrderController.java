...
import io.github.yuandonghao.yarch.examples.ddd.api.dto.CreateOrderRequest;
import io.github.yuandonghao.yarch.examples.ddd.api.dto.OrderResponse;
import io.github.yuandonghao.yarch.examples.ddd.application.service.OrderApplicationService;
...
public class OrderController {
    ...
    @io.github.yuandonghao.yarch.web.operlog.OperationLog(action = "order.place")
    ...
    @GetMapping
    public RestResponse<io.github.yuandonghao.yarch.common.web.PageData<OrderResponse>> list(
        ...
        return RestResponse.ok(
                io.github.yuandonghao.yarch.persistence.support.PageDatas.ofKeyset(
                        dtos, size, r -> String.valueOf(r.id())));
    }

    /** 状态机演示（E5）：pending → paid / cancelled；非法迁移 409+3004 */
    @io.github.yuandonghao.yarch.web.operlog.OperationLog(action = "order.pay")
    ...
    @io.github.yuandonghao.yarch.web.operlog.OperationLog(action = "order.cancel")
    ...
    @PostMapping("/probe")
    @io.github.yuandonghao.yarch.web.ratelimit.RateLimited(
            key = "order-probe",
            permits = 5,
            windowSeconds = 10)
