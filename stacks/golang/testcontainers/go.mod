module github.com/ydonghao/yarch/stacks/golang/testcontainers
...
require (
	...
	github.com/ydonghao/yarch/stacks/golang v0.0.0
...
replace github.com/ydonghao/yarch/stacks/golang => ../
